              ...
              <form method="POST" action="?mod=check">
                <fieldset>
                  <div class="form-group">
                    <label for="name_want_to_transfer">欲轉入域名名稱</label>
                    <input type="text" class="form-control" id="name_want_to_transfer" name="domain" placeholder="example.com">
                    <small id="name_want_to_transfer_Help" class="form-text text-muted">網址處於 pendingDelete 或 pendingTransfer 狀態時，以及 60 天內之新註冊或轉移之網址將無法轉入。</small>
